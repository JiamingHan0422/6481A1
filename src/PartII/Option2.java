...
public class Option2{
    ...
    public void update(int apdatenumber) {
        ...
        for(int i = 0; i < Main.computernumber; i++) {
            ...
            if(Main.inventory[i].getSN() == apdatenumber) {
